...
# # Backend URLs define
# LOAD_CHAT_URL = "http://135.237.121.62:5000/load_chat/"
# SAVE_CHAT_URL = "http://135.237.121.62:5000/save_chat/"
# DELETE_CHAT_URL = "http://135.237.121.62:5000/delete_chat/"
# UPLOAD_PDF_URL = "http://135.237.121.62:5000/upload_pdf/"
# CHAT_URL = "http://135.237.121.62:5000/chat/"
# RAG_CHAT_URL = "http://135.237.121.62:5000/rag_chat/"
...
#                 role = message.get("role")  # Use .get() to avoid KeyError
#                 if role:  # Check if role exists
#                     with st.chat_message(role):
#                         st.markdown(message["content"])
#                 else:
#                     st.warning(f"Message does not contain 'role': {message}")
